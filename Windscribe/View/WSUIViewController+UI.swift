...
extension WSUIViewController {
    ...
    func addGetMoreDataViews() {
        ...
        self.view.addSubview(getMoreDataView)
        ...
        self.view.addSubview(getMoreDataLabel)
        ...
        self.view.addSubview(getMoreDataButton)
    }
    ...
    func addAutolayoutConstraintsForGetMoreDataViews() {
        ...
        if UIScreen.hasTopNotch {
            ...
            view.addConstraints([
                NSLayoutConstraint(item: getMoreDataLabel as Any, attribute: .bottom, relatedBy: .equal, toItem: self.getMoreDataView, attribute: .bottom, multiplier: 1.0, constant: -8)
            ])
        }
        view.addConstraints([
            NSLayoutConstraint(item: getMoreDataLabel as Any, attribute: .top, relatedBy: .equal, toItem: self.getMoreDataView, attribute: .top, multiplier: 1.0, constant: 8),
            NSLayoutConstraint(item: getMoreDataButton as Any, attribute: .top, relatedBy: .equal, toItem: self.getMoreDataView, attribute: .top, multiplier: 1.0, constant: 8),
            NSLayoutConstraint(item: getMoreDataLabel as Any, attribute: .left, relatedBy: .equal, toItem: self.getMoreDataView, attribute: .left, multiplier: 1.0, constant: 16),
            NSLayoutConstraint(item: getMoreDataButton as Any, attribute: .right, relatedBy: .equal, toItem: self.getMoreDataView, attribute: .right, multiplier: 1.0, constant: -16)
        ])
        view.addConstraints([
            NSLayoutConstraint(item: getMoreDataView as Any, attribute: .leading, relatedBy: .equal, toItem: self.view, attribute: .leading, multiplier: 1.0, constant: 0),
            NSLayoutConstraint(item: getMoreDataView as Any, attribute: .trailing, relatedBy: .equal, toItem: self.view, attribute: .trailing, multiplier: 1.0, constant: 0),
            NSLayoutConstraint(item: getMoreDataView as Any, attribute: .centerX, relatedBy: .equal, toItem: self.view, attribute: .centerX, multiplier: 1.0, constant: 0),
            NSLayoutConstraint(item: getMoreDataView as Any, attribute: .bottom, relatedBy: .equal, toItem: self.view, attribute: .bottom, multiplier: 1.0, constant: 0),
