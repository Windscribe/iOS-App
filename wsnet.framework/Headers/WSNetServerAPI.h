...
-(WSNetCancelableCallback*)serverConfigs:(NSString*)authHash ovpnVersion:(NSString*)ovpnVersion callback:(void(^)(int, NSString*))callback;
...
-(WSNetCancelableCallback*)recordInstall:(NSString*)platform callback:(void(^)(int, NSString*))callback;
...
-(WSNetCancelableCallback*)staticIps:(NSString*)authHash platform:(NSString*)platform deviceId:(NSString*)deviceId callback:(void(^)(int, NSString*))callback;
...
-(WSNetCancelableCallback*)sendSupportTicket:(NSString*)supportEmail supportName:(NSString*)supportName supportSubject:(NSString*)supportSubject supportMessage:(NSString*)supportMessage supportCategory:(NSString*)supportCategory type:(NSString*)type channel:(NSString*)channel platform:(NSString*)platform callback:(void(^)(int, NSString*))callback;
...
-(WSNetCancelableCallback*)recordShakeForDataScore:(NSString*)authHash platform:(NSString*)platform score:(NSString*)score signature:(NSString*)signature callback:(void(^)(int, NSString*))callback;
